  ...
  <input type="text" class="form-control  ($errors->has('date_of_birth') ? ' is-invalid' : '')  " id="saksh_date_of_birth" name="date_of_birth"   value="{{$vendor->date_of_birth}}" placeholder="date_of_birth">
