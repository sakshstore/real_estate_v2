                        ...
                        <form method="POST" action="<?php echo e(route('post_set_update_other_fields', $property->id)); ?>"  role="form" enctype="multipart/form-data">
...
//echo "<input type='". $a->type. "' class= '". $a->className."'   name= '". $a->name."'  /> ";
        ...
        <button type="submit" class="btn btn-primary"><?php echo e(__('Submit')); ?></button>
									...
									<?php /**PATH /home/saksbqic/services/resources/views/property/edit_sections/other.blade.php ENDPATH**/ ?>