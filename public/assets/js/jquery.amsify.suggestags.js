    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        var AmsifySuggestags = function() {
            ...
            this.classes       = {
              ...
              inputArea     : '.amsify-suggestags-input-area form-control',
        ...
        AmsifySuggestags.prototype = {
            ...
            addTag : function(value) {
              ...
              $(this.selector).trigger('custom_event', [value]);
            ...
            printValues : function() {
                ...
                // $( "#planets_tag").text( this.tagNames ) ;
                  
                 
                 // $(this.selector).trigger('saksh_print_values', [this.tagNames ]);
